    ...
    for rfp_file in rfp_files:
        ...
        if data:
            ...
            # Specify the file path for RFP1
                ...
                question4 =  "국립국어원 어문연구실 한국어진흥과에 대한 정보에 대한 시작일과 마감일에 대해 알려줘"
                # Call the OpenAI API for each question for RFP1
                info1 = get_openai_response("ft:gpt-3.5-turbo-1106:personal::8qK0FcdU", "RFP2", question,partial_json_data_str1)
                info2 = get_openai_response("ft:gpt-3.5-turbo-1106:personal::8qK0FcdU", "RFP2", question2,partial_json_data_str1)
                info3 = get_openai_response("ft:gpt-3.5-turbo-1106:personal::8qK0FcdU", "RFP2", question3,partial_json_data_str2)
                info4 = get_openai_response("ft:gpt-3.5-turbo-1106:personal::8qK0FcdU", "RFP2", question4,partial_json_data_str1)
